...
if has_data_pre:
    ...
    summary_html = '<div class="info-sidebar-float">' + "\n".join(summary_lines) + '</div>'
    ...
    animated_html = '<div class="info-sidebar-float">' + "\n".join(animated_lines) + '</div>'
